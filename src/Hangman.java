...
public class Hangman
{
    ...
    public Hangman() throws IOException, InterruptedException {
        System.out.println("\n" +
    ...
    public void chooseWord() {
        curWord = words[new Random().nextInt(0, words.length)].toCharArray();
        guessedChar = ' ';
    ...
    public void printOutput() throws IOException, InterruptedException {
        System.out.println(hangmans[tries]);
        System.out.println("\nTries: " + tries);
        for(Character c: curWord) {
            if(containsChar(correctChars, c)) {
                System.out.print(c);
            }
            else {
                System.out.print("_");
    ...
    public void gameLoop() throws IOException, InterruptedException {
        ...
        for(Character c: curWord) {
            if(c == guessedChar && !containsChar(correctChars, c)) {
                correctChars.add(guessedChar);
            }
        }
        if(!containsChar(correctChars, guessedChar)) {
            tries--;
        }
        printOutput();
    }
